...
# Martha Gavidia- August 16 2023 - edited for task 6a
    ...
    try:
        ...
        if response_json:
            ...
            if response_payload:
                ...
                fluent_cohesive = values.get("fluent_cohesive", "")
                engaging_summary = values.get("engaging_summary", "")
                read_another = values.get("read_another", "")
                click_posts = values.get("click_posts", "")



        return is_rejected, fluent_cohesive, engaging_summary, read_another, click_posts
...
def process_csv():
    ...
    with open(input_file_path, mode="r") as input_file, open(output_file_path, mode="w", newline="") as output_file:
        ...
        fieldnames = ["job_id", "is_rejected", "fluent_cohesive", "engaging_summary", "read_another","click_posts"]
        ...
        for row in csv_reader:
            ...
            is_rejected, fluent_cohesive, engaging_summary, read_another, click_posts = extract_values(responses)

            csv_writer.writerow({
                "job_id": job_id,
                "is_rejected": is_rejected,
                "fluent_cohesive": fluent_cohesive,
                "engaging_summary": engaging_summary,
                "read_another": read_another,
                "click_posts": click_posts
            })
